    ...
    <div className="flex flex-col gap-8 lg:py-8 lg:px-12 p-4 bg-slate-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {UPCOMING_EVENTS.map((event) => (
          <Card key={event.id} className="overflow-hidden flex flex-col group transition-all hover:shadow-md">
      ...
      <div className="space-y-4 pt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 opacity-80">
          {PAST_EVENTS.map((event) => (
            <Card key={event.id} className="overflow-hidden bg-slate-50/50 grayscale-[0.5] hover:grayscale-0 transition-all">
              ...
              <CardHeader className="p-4 space-y-1">
                <p className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">{event.type}</p>
