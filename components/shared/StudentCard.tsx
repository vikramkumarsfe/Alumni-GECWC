            ...
            <CardContent className="flex flex-col gap-0">
                ...
                <div className="flex items-center gap-4 pb-4">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-[13px] text-slate-500 truncate mt-0.5">{student.job}</p>
                ...
                <div className="flex flex-col gap-2.5 mb-4">
                    ...
                    <div className="flex items-center gap-2.5 text-[13px] text-slate-500">
                        ...
                        <span>Batch of {student.batch}</span>
                    </div>
                    <div className="flex items-center gap-2.5 text-[13px] text-slate-500">
                        <MapPin size={13} className="flex-shrink-0 text-slate-400" />
                        <span>{student.address.city || "not updated"} { student.address.state}</span>
                    </div>
                </div>
                ...
                <div className="flex flex-wrap gap-1.5 mb-5">
                    {student.profile.skills && student.profile.skills.map((item : any, index : number) => (
                        <Badge
                            key={item}
                            variant="secondary"
               ...
               <div className="w-full">
                    <Link href={`/student/student-profile/${student._id}`}>
                    <Button
                        variant="outline"
