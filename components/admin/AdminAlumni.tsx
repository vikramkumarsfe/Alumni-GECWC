...
import { Table, Button, Tooltip, Select as AntSelect, Input as AntInput, Skeleton, message, Select } from 'antd';
...
const AdminAlumni = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "role",
      key: "role",
      // 1. Use 'role' for the cell value, and 'record' for the whole row object
      ...
      {rejectionUser && (
        <RejectUserModal
          ...
          onRejected={() => {
            ...
            void mutate(`/api/admin/users?page=${page}&limit=${pageSize}`)
          }}
        />
      )}
      {/* --- Page Header --- */}
