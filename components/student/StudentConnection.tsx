    ...
    <div className="bg-white border border-slate-200 rounded-2xl p-4 md:p-6 flex flex-col gap-4 shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Button 
          size="sm" 
          variant="outline" 
          className="w-9 h-9 p-0 shrink-0 text-red-500 border-red-100 hover:bg-red-50" 
    ...
    try {
      ...
      if (fcmToken) {
        const payload = {
          ...
          body : `Your alumni request is approved. Explore opportunities and start networking now.`
        }
