  ...
  return (
    ...
    >
      <div className="flex flex-col min-h-screen bg-white text-slate-900 selection:bg-blue-100 antialiased" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
        ...
        {/* --- HERO SECTION --- */}
        <section className=" max-w-7xl mx-auto p-4 md:pt-8">
          <Row  align="middle">
            <Col xs={24} lg={13}>
              <div className="space-y-6">
                ...
                <h1 className="text-4xl font-extrabold tracking-tighter leading-[1.05] text-slate-900">
                  Reconnect. Grow. <br/>
                ...
                <div className=" hidden md:grid grid-cols-2 gap-10 py-8 border-t border-slate-100 ">
        ...
        {/* --- STATS SECTION --- */}
        <section className="bg-slate-50/50 py-8 border-y border-slate-100">
          <div className="max-w-7xl mx-auto px-4">
            <Row gutter={[24, 24]}>
              { defaultData.map((stat, index) => (
        ...
        {/* --- FEATURES GRID --- */}
        <section className="md:py-24 py-12 max-w-7xl mx-auto px-4">
          <div className="text-center mb-16 space-y-4">
            <Badge className="bg-blue-50 text-blue-900 border-none px-3 py-1 font-bold text-xs uppercase tracking-widest">The Platform</Badge>
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-slate-900">Built for a connected ecosystem</h2>
        ...
        {/* --- EVENTS PREVIEW --- */}
        <section className="bg-white max-w-7xl mx-auto px-6 w-full">
        ...
        <section className="md:py-20 py-12 md:px-10 px-4 md:block hidden">
        ...
        <section className='md:py-20 py-12 md:px-10 px-4 md:hidden block flex items-center justify-center'>
            <Link href="/login" className='block cursor-pointer'>
              <Button size="lg" variant="secondary" className=" text-blue-900 hover:bg-blue-50 px-12 font-bold h-14 rounded-full cursor-pointer bg-blue-500 text-white">
                Join Alumni Network
              </Button>
            </Link>
        </section>
